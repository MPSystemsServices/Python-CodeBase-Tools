...
nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopytab.txt",
                  "TAB", bHeader=True, bStripBlanks=True)
print("Copy To TAB result:", nRet)

nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopy2.txt",
                  "CSV", bHeader=True, cTestExpr='CLIENTNAME="GP"', bStripBlanks=True)
print("Copy To CSV result:", nRet)
