...
nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopy.dbf",
                  "DBF")
print("Copy To DBF result:", nRet)

nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopy.sdf",
                  "SDF")
print("Copy To SDF result:", nRet)

nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopy.txt",
                  "CSV", bHeader=True, bStripBlanks=True)
print("Copy To CSV result:", nRet)

nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopytab.txt", "TAB",
                  bHeader=True, bStripBlanks=True)
print("Copy To TAB result:", nRet)

nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopy2.txt", "CSV",
                  bHeader=True, cTestExpr='CLIENTNAME="GP"', bStripBlanks=True)
print("Copy To CSV result:", nRet)

nRet = vfp.appendfrom(cAlias=cAlias2, cSource=gcRepoPath + "\\TestDataOutput\\clientscopy2.txt",
                      cType="CSV")
