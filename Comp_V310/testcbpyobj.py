...
nRet = vfp.copyto("TESTCLIENT", gcRepoPath + "\\TestDataOutput\\clientscopy.txt", "CSV",
...
cSourceFile = gcRepoPath + "\\TestDataOutput\\clientscopy2.txt"
nRet = vfp.appendfrom(cAlias=cAlias2, cSource=cSourceFile, cType="CSV")
...
cSourceFile = gcRepoPath + "\\TestDataOutput\\clientscopy.sdf"
nRet = vfp.appendfrom(cSource=cSourceFile)
vfp.goto("RECORD", 35)
cName = vfp.curval("CLIENTNAME", convertType=True)
print(cName)
