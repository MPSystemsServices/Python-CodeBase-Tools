...
cbWrap = CDLL(gcRepoPath + "\\CModules\\Comp_Wrappers64\\CodeBaseWrapper64.dll")
...
lnStart = time()
lnResult = cbWrap.cbwCREATETABLE(b"employees", lpFields)
print(lnResult)
lnEnd = time()
print("time:", lnEnd - lnStart)
print(cbWrap.cbwERRORMSG())
lnResult = cbWrap.cbwINDEXON(b"firstname", b"firstname", b"", 0, 0)
lnResult = cbWrap.cbwAPPENDBLANK()
lnResult = cbWrap.cbwREPLACE_CHARACTER(b"firstname", b"charlie")
print("Replacing: ", lnResult)

lnResult = cbWrap.cbwUSEEXCL(b"data2.dbf", b"DATA2")
...
lnResult = cbWrap.cbwUSE(b"E:\\LoadBuilder2\\AppDBFS\\FACLOGPR\\shipmstr.dbf", b"shipmstr", 0)
print(lnResult)
lnResult = cbWrap.cbwGOTO(b"RECORD", 55)
...
print("string Typeck: ", isinstance(xStr, str))
...
print(lnResult)
lnResult = cbWrap.cbwGOTO(b"RECORD", 55)
print("ERROR RESULT:", lnResult)
cErr = cbWrap.cbwERRORMSG()
print("ERROR MSG:", cErr)

lnResult = cbWrap.cbwUSEEXCL(b"employees.dbf", b"EMPL2")
print("DATA2 Exclusive Open: ", lnResult)
print("ERROR MSG:", cErr)
