@echo off
SET LIB=d:\VisualStudio2015\VC\LIB;E:\GIT_Repositories\Python-CodeBase-Tools\Comp_V3X;C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22621.0\ucrt\x86;C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22621.0\um\x86;c:\python313\lib
...
set CMODULESHOME=E:\GIT_Repositories\Python-CodeBase-Tools\Comp_V3X\CMODULES
